...
import org.usfirst.frc.team6002.lib.util.ConstantsBase;
...
//    public static double kHoodDeadband = 0.3; // degrees
    ...
    // Units: error is 4096 counts/rev. Max output is +/- 1023 units.
    public static double kGearArmMotorKp = 0.7;
    public static double kGearArmMotorKi = 0.0;
    public static double kGearArmMotorKd = 30.0;
    public static double kGearArmMotorKf = 0;
    public static int kGearArmMotorIZone = (int) (1023.0 / kGearArmMotorKp);
    public static double kGearArmMotorRampRate = 0;
    public static int kGearArmMotorAllowableError = 100;
